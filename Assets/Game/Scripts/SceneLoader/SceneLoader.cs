...
namespace DP
{
    ...
    {
        private float _minTimeLoading = 0.5f;
        private int _loaderSceneIndex = 2;
        private int _gameplaySceneIndex = 1;
        private Coroutine _sceneLoadingCoroutine;
        private int _curSceneIndex = 0;

        public void LoadGameplayScene(Action<float> progress = null, Action onCompleted = null, Action onFadeInCompleted = null, Action onFadeOutStarted = null)
        {
